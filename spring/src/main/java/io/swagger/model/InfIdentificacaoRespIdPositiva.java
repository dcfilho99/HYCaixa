...
@Pattern(regexp="^.{0,7}$")   public String getPos1() {
    return pos1;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos2() {
    return pos2;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos3() {
    return pos3;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos4() {
    return pos4;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos5() {
    return pos5;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos6() {
    return pos6;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos7() {
    return pos7;
  }
...
@Pattern(regexp="^.{0,7}$")   public String getPos8() {
    return pos8;
  }
