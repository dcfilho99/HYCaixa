...
@Pattern(regexp="^\\d{11}$")   public String getCpfDepositante() {
    return cpfDepositante;
  }
...
@Pattern(regexp="^\\d+$")   public String getNumConta() {
   ...
   * @return nomeBanco
  **/
  @ApiModelProperty(example = "Banco da Nova Parceria", value = "Nome do banco utilizado na operação.")
  ...
  **/
  @ApiModelProperty(example = "Depósito do aluguel.", value = "Identificação genérica quando o depósito for identificado.")
