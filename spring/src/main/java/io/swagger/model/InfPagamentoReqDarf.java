...
@Pattern(regexp="^\\d{8}$")   public String getPeriodoApuracao() {
    return periodoApuracao;
  }
...
@Pattern(regexp="^\\d+$")   public String getNumReferencia() {
    return numReferencia;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorPrincipal() {
    return valorPrincipal;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorMulta() {
    return valorMulta;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorJuros() {
    return valorJuros;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorTotal() {
    return valorTotal;
  }
