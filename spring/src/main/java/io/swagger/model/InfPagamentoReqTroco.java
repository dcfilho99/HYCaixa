...
@Pattern(regexp="^\\d{12}$")   public String getValorCreditoConta() {
    return valorCreditoConta;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorEspecie() {
    return valorEspecie;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorDoacao() {
    return valorDoacao;
  }
...
@Pattern(regexp="^\\d{14}$")   public String getCnpjInstituicao() {
    return cnpjInstituicao;
  }
...
@Pattern(regexp="^\\d{12}$")   public String getValorCupom() {
    return valorCupom;
  }
