...
public class ConsultaTaxasApiController implements ConsultaTaxasApi {
    ...
    public ResponseEntity<ConsultaTaxasResp> consultaTaxasPost(@ApiParam(value = "Requisição de consulta de taxas." ,required=true )  @Valid @RequestBody ConsultaTaxasReq body,@ApiParam(value = "Tipo de autenticação requerida." ,required=true) @RequestHeader(value="authenticationType", required=true) String authenticationType,@ApiParam(value = "Identificação do cliente." ,required=true) @RequestHeader(value="clientId", required=true) String clientId,@ApiParam(value = "Chave para validação do acesso ao serviço." ,required=true) @RequestHeader(value="token", required=true) String token) {
