...
@Controller
public class ConsultaLimitesEmprestimoApiController implements ConsultaLimitesEmprestimoApi {

    private static final Logger log = LoggerFactory.getLogger(ConsultaLimitesEmprestimoApiController.class);
    ...
    public ConsultaLimitesEmprestimoApiController(ObjectMapper objectMapper, HttpServletRequest request) {
