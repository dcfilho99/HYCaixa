...
public interface ConsultaSaqueApi {
    ...
    @ApiOperation(value = "", nickname = "consultaSaquePost", notes = "Operação de consulta de saque, para verificar se o saque poderá ser efetuado.", response = ConsultaSaqueResp.class, tags={  })
    @ApiResponses(value = { 
