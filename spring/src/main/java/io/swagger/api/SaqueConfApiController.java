...
@Controller
public class SaqueConfApiController implements SaqueConfApi {

    private static final Logger log = LoggerFactory.getLogger(SaqueConfApiController.class);
    ...
    public SaqueConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
