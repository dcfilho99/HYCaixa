...
@Api(value = "consultaTitulosCapitalizacao", description = "the consultaTitulosCapitalizacao API")
public interface ConsultaTitulosCapitalizacaoApi {
