...
public interface ConsultaPagamentoApi {
    ...
    @ApiOperation(value = "", nickname = "consultaPagamentoPost", notes = "Operação de consulta de pagamentos.", response = ConsultaPagamentoResp.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Retorno com sucesso.", response = ConsultaPagamentoResp.class) })
