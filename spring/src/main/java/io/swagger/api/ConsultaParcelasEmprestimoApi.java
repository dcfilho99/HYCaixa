...
public interface ConsultaParcelasEmprestimoApi {
    ...
    @ApiOperation(value = "", nickname = "consultaParcelasEmprestimoPost", notes = "Operação de consulta das parcelas do empréstimo.", response = ConsultaParcelasEmprestimoResp.class, tags={  })
    @ApiResponses(value = { 
