...
@Controller
public class SaldoApiController implements SaldoApi {

    private static final Logger log = LoggerFactory.getLogger(SaldoApiController.class);
