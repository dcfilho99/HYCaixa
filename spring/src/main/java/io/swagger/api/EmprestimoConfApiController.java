...
@Controller
public class EmprestimoConfApiController implements EmprestimoConfApi {

    private static final Logger log = LoggerFactory.getLogger(EmprestimoConfApiController.class);
    ...
    public EmprestimoConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
