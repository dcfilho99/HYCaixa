...
@Controller
public class RecargaConfApiController implements RecargaConfApi {

    private static final Logger log = LoggerFactory.getLogger(RecargaConfApiController.class);
    ...
    public RecargaConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
