...
@Controller
public class DepositoConfApiController implements DepositoConfApi {

    private static final Logger log = LoggerFactory.getLogger(DepositoConfApiController.class);
    ...
    public DepositoConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
